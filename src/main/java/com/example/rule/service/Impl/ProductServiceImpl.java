...
import com.example.rule.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    List<String> listProductId = Arrays.asList(
            "4241412000773",
            "4241412000035",
            "1073200001027",
            "1073200001028",
    ...
    List<Integer> listPriceProduct  = Arrays.asList(
...
//            productEntity.setProductId(uuid.toString());
            productEntity.setProductId(listProductId.get(i - 1));
            productEntity.setProductName("product "+ (i + 1));
            productEntity.setColor("Blue");
            productEntity.setPrice(BigInteger.valueOf(listPriceProduct.get(i - 1)));
            productEntity.setBusinessStatus("Active");
            productEntity.setProductStatus("Active");
            productEntity.setDebutDate(new Date());
            productEntity.setExpiryDate(new Date());
            CategoryEntity categoryEntity = new CategoryEntity();
            categoryEntity.setCategoryId(UUID.fromString("0bc42b15-ec89-43f5-a378-0ee40a49db6c"));
            productEntity.setCategoryByCategoryId(categoryEntity);
            ManufacturerEntity manufacturerEntity = new ManufacturerEntity();
            manufacturerEntity.setManufacturerId(UUID.fromString("0bc42b15-ec89-43f5-a378-0ee40a49db6c"));
            productEntity.setManufacturerByManufacturerId(manufacturerEntity);
    ...
    public List<ProductDTO> getAllProduct() {
        ...
        for (ProductEntity product : products) {
            productDTO = this.EntityToDto(product);
    ...
    public ProductDTO EntityToDto(ProductEntity entity) {
        ...
        productDTO.setExpiryDate(new Date(entity.getExpiryDate().getTime()));
        productDTO.setDebutDate(new Date(entity.getDebutDate().getTime()));
        productDTO.setProductStatus(entity.getProductStatus());
        productDTO.setBusinessStatus(entity.getBusinessStatus());
        productDTO.setManufacturerByManufacturerId(entity.getManufacturerByManufacturerId().getManufacturerId());
        productDTO.setCategoryByCategoryId(entity.getCategoryByCategoryId().getCategoryId());
        return productDTO;
    }
